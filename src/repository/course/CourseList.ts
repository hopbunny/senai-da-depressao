...
export default <Course[]>[
    ...
    {
        title: 'Como ser Chavoso',
        desc: '',
        duration: '57 segundos',
        stars: 5.0,
        thumb: '/img/cursos/senai-2.png',
        url: 'https://www.youtube.com/watch?v=pwngQ42RVTo'
    },
    {
        title: 'Jogo do Bicho',
        desc: '',
        ...
        stars: 5.0,
        thumb: '/img/cursos/senai-8.jpg',
        url: 'https://www.youtube.com/watch?v=jZQR2BvRkn8'
    ...
    {
        title: 'Narração de Bingos',
        desc: '',
        duration: '30 segundos',
        stars: 2.8,
        thumb: '/img/cursos/senai-7.jpg',
        url: 'https://www.youtube.com/shorts/SV9IBWmoclE'
    },
    {
    ...
    {
        title: 'Manutenção de Caça-Níquel',
        desc: '',
        duration: '11 segundos',
        stars: 3.2,
        thumb: '/img/cursos/senai-11.jpg',
        url: 'https://www.youtube.com/watch?v=5S-VaL6oFm4'
    },
    {
    ...
    {
        title: 'Miojo Turbinado',
        desc: '',
        duration: '23 segundos',
        stars: 4.0,
        thumb: '/img/cursos/senai-14.jpg',
        url: 'https://www.youtube.com/watch?v=nt9Zhzwc5Lk'
    },
];